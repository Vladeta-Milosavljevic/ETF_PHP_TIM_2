            ...
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <input type="text"
                        ...
                        value="<?= $obrazlozenje['oblast_rada'] ?>">
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <textarea type="text" rows="6"
                        ...
                        placeholder="Предмет, циљ и методе мастер рада:"><?= $obrazlozenje['predmet_cilj_metode'] ?><?= $obrazlozenje['predmet_cilj_metode'] ?></textarea>
                </div>
            ...
            <div class="col-sm-6 col-xs-12">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" rows="7"
                        ...
                        placeholder="Садржај и очекивани резултати мастер рада:"><?= $obrazlozenje['sadrzaj_ocekivani_rezultat'] ?></textarea>
                </div>
